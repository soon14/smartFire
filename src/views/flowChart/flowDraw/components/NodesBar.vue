  ...
  .nodes-bar {
    ...
    li {
      ...
      .general-node {
        ...
        border-radius: 4px;
        margin: 10px auto;
        background: url(../../../../assets/images/flowIcon/label.png) no-repeat center / 30px;
      }
      ...
      .start-node {
        ...
        margin: 10px auto;
        background: url(../../../../assets/images/flowIcon/start.png) no-repeat center / 20px 20px;
      }
      ...
      .end-node {
        ...
        margin: 10px auto;
        background: url(../../../../assets/images/flowIcon/end.png) no-repeat center / 20px 20px;
      }
      ...
      .special-node {
        ...
        border-radius: 4px;
        background: url(../../../../assets/images/flowIcon/edit.png) no-repeat center / 20px 20px;
      }
